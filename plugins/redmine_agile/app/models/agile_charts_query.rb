...
class AgileChartsQuery < AgileQuery
  ...
  def build_from_params(params)
    ...
    self.group_by = params[:group_by] || (params[:agile_charts_query] && params[:agile_charts_query][:group_by])
    self.column_names = params[:c] || (params[:agile_charts_query] && params[:agile_charts_query][:column_names])
