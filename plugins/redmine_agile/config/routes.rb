...
get '/agile/charts/render_version_chart', :to => "agile_charts#render_version_chart"
get '/agile/charts/select_version_chart', :to => "agile_charts#select_version_chart"
get '/agile/board', :to => 'agile_board#index'
put '/agile/board', :to => 'agile_board#update', :as => 'update_agile_board'
get '/agile/board/load_more', :to => 'agile_board#load_more', :as => 'load_more_issues'
