...
class InvoicesController < ApplicationController
  ...
  def index
    ...
    @estimate_status_sum, @estimate_status_count = invoices_sum_by_status(Invoice::ESTIMATE_INVOICE)
    ...
    @canceled_status_sum, @canceled_status_count = invoices_sum_by_status(Invoice::CANCELED_INVOICE)
  ...
  def show
    ...
    @estimate_status_sum, @estimate_status_count = invoices_sum_by_status(Invoice::ESTIMATE_INVOICE, @invoice.contact_id)
    ...
    @canceled_status_sum, @canceled_status_count = invoices_sum_by_status(Invoice::CANCELED_INVOICE, @invoice.contact_id)
  ...
  def find_invoices(pages=true)
    ...
    scope = scope.scoped(:conditions => ["#{Invoice.table_name}.paid_date BETWEEN ? AND ?", @from, @to]) if (@from && @to) && params[:paid_period]
